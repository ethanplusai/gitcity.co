...
- Runtime package dependencies resolve to neighborhood links through package repository metadata. Currently up to four links to materialized destinations are drawn as flat roads from neighborhood edges. Verified npm usage remains available as source data; animated usage traffic is paused during this rendering rebuild.
